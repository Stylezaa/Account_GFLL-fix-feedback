...
document.getElementById("layout-menu") && (isHorizontalLayout = document.getElementById("layout-menu").classList.contains("menu-horizontal")), function () {
    ...
    let e = document.getElementsByClassName("menu-inner"), o = document.getElementsByClassName("menu-inner-shadow")[0];
...
"undefined" != typeof $ && $(function () {
    ...
    var t, n, e, o = $(".search-toggler"), s = $(".search-input-wrapper"), a = $(".search-input"),
        l = $(".content-backdrop");
    o.length && o.on("click", function () {
        ...
        return function (t, e) {
            ...
            n = [], o.filter(function (e) {
                if (e.name.toLowerCase().startsWith(t.toLowerCase())) n.push(e); else {
