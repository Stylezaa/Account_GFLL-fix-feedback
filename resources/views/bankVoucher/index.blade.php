...
@section('content')
    ...
    <div class="col col-12 flex-column">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">{{\App\Helpers\GetLang::locale('bankVoucher.title')}}</span>
            <a href="{{route('bankVoucher.add',['action'=>'more','key'=>null])}}" class="btn btn-primary float-end">{{\App\Helpers\GetLang::locale('bankVoucher.new')}}
    ...
    <div class="card p-3">
        <form method="GET" action="{{route('bankVoucher.index')}}">
            <div class="row mt-5 mb-5">
                <div class="col col-md-3">
                    <div class="input-group">
                        <label for="startDate" class="form-label m-3">{{\App\Helpers\GetLang::locale('bankVoucher.startDate')}}</label>
                ...
                <div class="col col-md-3">
                    <div class="input-group">
                        <label for="startDate" class="form-label m-3">{{\App\Helpers\GetLang::locale('bankVoucher.endDate')}}</label>
                ...
                <div class="col col-md-3">
                    <button class="btn btn-primary mt-1 text-white" type="submit">
                        ...
                        {{\App\Helpers\GetLang::locale('bankVoucher.searchBtn')}}
                    </button>
                </div>
            </div>
        </form>
        ...
        <bank-voucher-index :vouchers="{{json_encode($vouchers)}}" :start-date1="{{json_encode($startDate)}}" :end-date1="{{json_encode($presentDate)}}" :locale="{{json_encode(\App\Helpers\GetLang::getLangCode())}}"></bank-voucher-index>
    </div>
