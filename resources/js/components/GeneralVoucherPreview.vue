    ...
    methods: {
        async callVoucherData() {
            try {
                ...
                await axios.get(`${process.env.MIX_APP_URL}:${process.env.MIX_APP_PORT}/GeneralVoucher/preview/data/${query.get('level')}/${query.get('implementCD')}/${query.get('voucherNo')}`, {
                    headers: {
