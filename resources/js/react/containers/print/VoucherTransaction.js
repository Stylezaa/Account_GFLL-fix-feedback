...
const VoucherTransactionReport = () => {
    ...
    const fetchGetDataReport = async () => {
        try {
            const res = await axios.post(`/print/voucher-transaction/data`, {
                ...queryParams,
            });
            ...
            setDataReport([]);
            console.log("error fetchGetVoucherTransactionReportLevel", error);
        }
    };
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <strong>ລາຍງານການເຄື່ອນໄຫວ</strong>
                </h4>
            </div>
                    ...
                    >
                        <thead>
                            ...
                            >
                                ...
                                <th rowSpan={2}>ເລກທີແຊັກ</th>
                                <th rowSpan={2}>ເລກທີຈ່າຍ ລ່ວງໜ້າ</th>
                                ...
                                <th rowSpan={2}>ຜູ້ນໍາໃຊ້ທຶນ</th>
                                <th rowSpan={2}>ຜູ້ນໍາໃຊ້ທຶນຍ່ອຍ</th>
                                <th colSpan={2}>ມູນຄ່າລົງບັນຊີ (ກີບ)</th>
                                <th rowSpan={2}>ອັດຕາ</th>
                                <th colSpan={2}>ມູນຄ່າລົງບັນຊີ (ໂດລາ)</th>
                            </tr>
                            <tr
                                style={{
                                    textAlign: "center",
                            ...
                            {dataReport && dataReport.length > 0 ? (
                                dataReport.map((data, index) => (
                                    <tr key={index}>
                                        ...
                                        >
                                            {numberFormat(data.exchange_rate)}
                                        </td>
                                        <td
                                            style={{
                                                textAlign: "right",
...
const root = ReactDOM.createRoot(
    document.getElementById("print-transaction-report")
);

root.render(<VoucherTransactionReport />);
