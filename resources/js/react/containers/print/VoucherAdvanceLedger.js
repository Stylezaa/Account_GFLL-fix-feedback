...
const VoucherAdvanceLedger = () => {
    ...
    const fetchGetVoucher = async (level, implementCD, voucherNo) => {
        try {
            const res = await axios.get(
                `/VoucherAdvance/preview/data/${level}/${implementCD}/${voucherNo}`,
                {
                    headers: {
    ...
    }, [query.get("level"), query.get("implementCD"), query.get("voucherNo")]);
...
const root = ReactDOM.createRoot(
    document.getElementById("print-voucher-advance-ledger")
);

root.render(<VoucherAdvanceLedger />);
