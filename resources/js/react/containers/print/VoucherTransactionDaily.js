    ...
    const fetchGetDataReport = async () => {
        try {
            const res = await axios.post(
                `/print/voucher-transaction-daily/data`,
                {
                    ...queryParams,
                }
            );
            ...
            setDataReport([]);
            console.log("error fetchGetVoucherTransactionDailyLevel", error);
        }
    };
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <strong>ລາຍງານປະຈຳວັນທົ່ວໄປ</strong>
                </h4>
            </div>
...
const root = ReactDOM.createRoot(
    document.getElementById("print-transaction-daily-report")
);

root.render(<VoucherTransactionDaily />);
